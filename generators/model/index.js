...
var modulesSource = 'app/models',
      testsSource = 'app/tests';
...
module.exports = yeoman.generators.Base.extend({
  ...
  askForModuleDirectory: function (cb) {
    ...
    var prompts = [{
      ...
      {
        value: '',
        name: 'Select this directory(' + modulesSource + ')'
      }]
    }];
  ...
  askForModuleName: function () {
    ...
    this._prompt(prompts, function(props) {
      ...
      this.name = this.props.name || 'new-mongoose-model';
  ...
  writing: function () {
    ...
    this.fs.copyTpl(
      this.templatePath('_.model.js'),
      this.destinationPath(this.destination + this.slugifiedName + '.model.js'), {
    ...
    //** Generate `mongoose` model unit test
    this.fs.copyTpl(
      this.templatePath('_.model.spec.js'),
      this.destinationPath(testsSource + '/' + this.slugifiedName + '.model.spec.js'), {
