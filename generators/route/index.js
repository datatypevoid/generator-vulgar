...
module.exports = yeoman.generators.Base.extend({
  ...
  askForModuleName: function () {
    ...
    this._prompt(prompts, function(props) {
      ...
      this.name = this.props.name || 'new-express-route';
  ...
  writing: function () {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.destination + this.slugifiedName + '.route.js'), {
    ...
    /*//** Generate `express` route unit test
    this.fs.copyTpl(
      this.templatePath('_.route.spec.js'),
      this.destinationPath(testsSource + '/' + this.slugifiedName + '.route.spec.js'), {
