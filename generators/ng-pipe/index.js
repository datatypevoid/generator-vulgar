...
module.exports = yeoman.generators.Base.extend({
  ...
  askForModuleDirectory: function (cb) {
    ...
    var prompts = [{
      type: 'list',
      name: 'module',
      message: 'Where would you like to create this pipe?',
  ...
  askForModuleName: function () {
    ...
    this._prompt(prompts, function(props) {
      ...
      this.name = this.props.name || 'ng-pipe';
  ...
  writing: function () {
    ...
    this.fs.copyTpl(
      this.templatePath('_.pipe.ts'),
      this.destinationPath(this.destination + this.slugifiedName + '.pipe.ts'), {
    ...
    //** Generate `Angular` pipe unit test
    this.fs.copyTpl(
      this.templatePath('_.pipe.spec.ts'),
      this.destinationPath(this.destination + this.slugifiedName + '.pipe.spec.ts'), {
