...
module.exports = yeoman.generators.Base.extend({
  ...
  askForModuleName: function () {
    ...
    this._prompt(prompts, function(props) {
      ...
      this.name = this.props.name || 'ng-component';
  ...
  writing: function () {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.destination + this.slugifiedName + '.component.ts'), {
    ...
    this.fs.copyTpl(
      this.templatePath('_.component.spec.ts'),
      this.destinationPath(this.destination + this.slugifiedName + '.component.spec.ts'), {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.destination + this.slugifiedName + '.component.html'), {
    ...
    this.fs.copy(
      this.templatePath('_.component.scss'),
      this.destinationPath(this.destination + this.slugifiedName + '.component.scss')
    );
  },
